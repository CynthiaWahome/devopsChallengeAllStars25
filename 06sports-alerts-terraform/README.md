...
├── alerts.py         # Main Lambda function code
├── alerts.zip        # Main Lambda function zipped file
├── main.tf    # Game Day notification Terraform config file
├── LICENSE                     
├── .gitignore
